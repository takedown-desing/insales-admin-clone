...
const ICO = {
  ...
  order: 'M4 7h16v13H4zM4 7l2-3h12l2 3M9 11h6',
  box: 'M12 3 3 7.5v9L12 21l9-4.5v-9zM3 7.5 12 12l9-4.5M12 12v9',
  truck: 'M3 7h11v9H3zM14 10h4l3 3v3h-7zM7 19a2 2 0 1 0 0-.1M17.5 19a2 2 0 1 0 0-.1',
  chart: 'M4 19V5M4 19h16M8 15l3-4 3 3 4-6',
  promo: 'M12 3a5 5 0 0 0-5 5v3l-2 4h14l-2-4V8a5 5 0 0 0-5-5M9.5 19a2.5 2.5 0 0 0 5 0',
  users: 'M8 11a3.2 3.2 0 1 0 0-6.4A3.2 3.2 0 0 0 8 11ZM2.5 19c0-3 2.5-5 5.5-5s5.5 2 5.5 5M16 8h5M16 12h5M16 16h5',
  chat: 'M4 5h16v10H9l-5 4z',
  site: 'M3 5h18v11H3zM8 20h8M12 16v4',
  help: 'M12 3a9 9 0 1 1 0 18 9 9 0 0 1 0-18M9.6 9.4A2.4 2.4 0 1 1 12 12v1.6M12 17h.01',
  plug: 'M6 3v6M14 3v6M4 9h12v3a6 6 0 0 1-12 0zM10 18v3',
  wallet: 'M3 7h15v11H3zM3 7l3-3h11v3M16 12h3',
  gear: 'M12 9.2a2.8 2.8 0 1 0 0 5.6 2.8 2.8 0 0 0 0-5.6M4 12l-1.4-1 1.2-2.8 1.7.3M20 12l1.4-1-1.2-2.8-1.7.3M12 4V2M12 22v-2',
};
function icon(name) {
  return `<svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="${ICO[name] || ICO.box}"/></svg>`;
}
...
function renderNav() {
  ...
  $('#nav').innerHTML = NAV.map(item).join('') +
    `<div class="side-foot">` + NAV_FOOT.map(item).join('') + `</div>`;
}
